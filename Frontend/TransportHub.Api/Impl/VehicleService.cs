...
public class VehicleService : IVehicleService
{
    ...
    private const string _pathPrefix = "vehicles";
    ...
    public async Task<Result<bool, Exception>> Add(VehicleUpdateDto vehicleDto)
    {
    ...
    public async Task<Result<VehicleDto, Exception>> Get(string id)
    {
        var uri = _settingsService.Read(Settings.IpAddress, DefaultValues.ServerAddress);
        ...
        var users = _jsonSerializer.Deserialize<VehicleDto>(content);

        return users!;
    }

    public async Task<Result<IEnumerable<VehicleDto>, Exception>> List()
    {
        var uri = _settingsService.Read(Settings.IpAddress, DefaultValues.ServerAddress);
        ...
        var users = _jsonSerializer.Deserialize<IEnumerable<VehicleDto>>(content);
    ...
    public async Task<Result<bool, Exception>> Update(string id, VehicleUpdateDto vehicleDto)
    {
        var uri = _settingsService.Read(Settings.IpAddress, DefaultValues.ServerAddress);
