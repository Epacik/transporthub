...
public class DriverService : IDriverService
{
    ...
    private const string _pathPrefix = "drivers";
    ...
    public async Task<Result<bool, Exception>> Add(DriverUpdateDto DriverDto)
    {
        ...
        var data = _jsonSerializer.Serialize(DriverDto);
    ...
    public async Task<Result<DriverDto, Exception>> Get(string id)
    {
        var uri = _settingsService.Read(Settings.IpAddress, DefaultValues.ServerAddress);
        ...
        var users = _jsonSerializer.Deserialize<DriverDto>(content);

        return users!;
    }

    public async Task<Result<IEnumerable<DriverDto>, Exception>> List()
    {
        var uri = _settingsService.Read(Settings.IpAddress, DefaultValues.ServerAddress);
        ...
        var users = _jsonSerializer.Deserialize<IEnumerable<DriverDto>>(content);
    ...
    public async Task<Result<bool, Exception>> Update(string id, DriverUpdateDto DriverDto)
    {
        var uri = _settingsService.Read(Settings.IpAddress, DefaultValues.ServerAddress);
