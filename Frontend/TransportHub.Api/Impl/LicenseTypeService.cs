...
public class LicenseTypeService : ILicenseTypeService
{
    ...
    private const string _pathPrefix = "licenses";
    ...
    public async Task<Result<bool, Exception>> Add(LicenseTypeUpdateDto licenseTypeDto)
    {
        ...
        var data = _jsonSerializer.Serialize(licenseTypeDto);
    ...
    public async Task<Result<LicenseTypeDto, Exception>> Get(string id)
    {
        var uri = _settingsService.Read(Settings.IpAddress, DefaultValues.ServerAddress);
        ...
        var users = _jsonSerializer.Deserialize<LicenseTypeDto>(content);

        return users!;
    }

    public async Task<Result<IEnumerable<LicenseTypeDto>, Exception>> List()
    {
        var uri = _settingsService.Read(Settings.IpAddress, DefaultValues.ServerAddress);
        ...
        var users = _jsonSerializer.Deserialize<IEnumerable<LicenseTypeDto>>(content);
    ...
    public async Task<Result<bool, Exception>> Update(string id, LicenseTypeUpdateDto licenseTypeDto)
    {
        var uri = _settingsService.Read(Settings.IpAddress, DefaultValues.ServerAddress);
